package com.digicade.android.formulariobase.nicespinner;
...
import com.digicade.android.formulariobase.R;
...
//                mDrawable = DrawableCompat.wrap(basicDrawable;
    ...
    public void setOnSelected(OnSelected mOnSelected) {
...
//        animator.setInterpolator(new LinearInterpolator()); LinearOutSlowInInterpolator()
        animator.start();
    }
